import { Mail, Phone, ExternalLink, Code2, Globe, Palette, Layout } from 'lucide-react';
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['React.js', 'Node.js', 'MongoDB', 'Express.js', 'Tailwind CSS', 'Website Design'].map((skill) => (
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { icon: Layout, label: 'Website RedDesign' }
                  ].map((service) => (
...
// Import Utensils for the services list
