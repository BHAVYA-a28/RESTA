        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 relative space-y-6">
               ...
               <div className="pt-6">
                 <Link to="/contact" className="text-primary font-bold inline-flex items-center space-x-2 border-b-2 border-primary/20 pb-2 hover:border-primary transition-all">
