  ...
  return (
    <section className="relative min-h-[90vh] flex items-center bg-white overflow-hidden py-12 md:py-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
        ...
        >
          <div>
            <span className="bg-primary/10 text-primary font-bold px-6 py-2 rounded-full uppercase tracking-widest text-[10px] inline-block mb-6 shadow-sm border border-orange-100/50 animate-in fade-in duration-1000">Award-Winning Gastronomy</span>
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold font-headings leading-[1.1] tracking-tighter text-gray-900">
              Spice of <br />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
            <Link href="/menu" className="w-full sm:w-auto bg-primary text-white px-12 py-5 rounded-[24px] font-bold text-lg hover:bg-orange-600 hover:scale-105 transition-all shadow-2xl shadow-orange-200 flex items-center justify-center space-x-3 group">
              <span>Explore Menu</span>
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/reservation" className="w-full sm:w-auto bg-white border border-gray-100 text-gray-900 px-12 py-5 rounded-[24px] font-bold text-lg hover:bg-gray-50 transition-all shadow-sm">
              Secure a Table
            </Link>
          </div>
        ...
        >
           <div className="relative z-10 p-6 glass-morphism rounded-[60px] shadow-2xl overflow-hidden group border border-white/50 backdrop-blur-2xl bg-white/30">
             <motion.img
           ...
           >
              ...
              <p className="font-bold text-gray-900 text-lg leading-tight">Dinner Service <br /><span className="text-primary font-headings font-bold">18:00 - 22:00</span></p>
           </motion.div>
        </motion.div>
      </div>
    </section>
